...
<br>
<footer class="" style="background-color: #259d6d">
    <div class=" container " >
        <div class="row" >
            <div class="col-md-3 col-sm-6 pl-0">
                <ul class="nav flex-column" id="JB">
            ...
            <div class="col-md-4 ml-auto text-right">
                ...
                <ul class="nav justify-content-end" id="JB">
                    <li class="nav-item"><a style="color:white;background-color: transparent" href="#" class="nav-link pr-0"><i class="fa fa-pinterest fa-lg"></i></a></li>
                    <li class="nav-item"><a style="color:white;background-color: transparent" href="#" href="#" class="nav-link pr-0"><i class="fa fa-twitter fa-lg"></i></a></li>
