    ...
    <div class="Heading1" style="text-align:left;  margin-top:12px;">
        ...
        <table class="table table-bordered" width="604" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr class="RowBG2">
                ...
                <td colspan="2" class="fasla RowBG1 specs-value bottom-border">{{$mobile->Maincamera}}                                                  &nbsp;</td>
            </tr>
            ...
            <tr class="RowBG2">
                ...
                <td colspan="2" class="fasla RowBG1 specs-value bottom-border">{{$mobile->WLAN}}                                                    &nbsp;</td>
            </tr>
            ...
            <tr class="RowBG1">
                ...
                <td colspan="2" class="fasla specs-value bottom-border-section">
                    {{--<font color='#000077'><b>GPRS</b></font>, <font color='#000077'><b>EDGE</b></font>{{$mobile->}}                                                &nbsp;</td>--}}
                    <font color='#000077'><b>GPRS</b></font>, <font color='#000077'><b>EDGE</b></font>{{$mobile->Data}}                                                &nbsp;</td>
            </tr>
            ...
            <tr class="RowBG2">
                ...
                <td colspan="2" class="fasla RowBG1 specs-value bottom-border">{{$mobile->Sensors}}                                                   &nbsp;</td>
            </tr>
            ...
            <tr class="RowBG2">
                ...
                <td colspan="2" class="fasla RowBG1 specs-value bottom-border">{{$mobile->Capacity}}                                                   &nbsp;</td>
            </tr>
            ...
            <tr class="RowBG2">
                ...
                <td colspan="2" class="fasla RowBG1 bottom-border-section right-border specs-subHeading">Price in Rs: <strong>{{$mobile->price}}</strong> &nbsp;&nbsp;&nbsp;Price in USD: <strong><?php ?></strong>
                    &nbsp;</td>
            </tr>
            <tr class="RowBG2">
